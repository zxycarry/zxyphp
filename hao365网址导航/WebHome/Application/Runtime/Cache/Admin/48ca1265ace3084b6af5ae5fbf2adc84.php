                    ...
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                            <div class="row">
                                ...
                                <!--搜索开始-->
                                <form method="post" action="/WebHome/index.php/Admin/MiddleLevel/lists/p/5.html" >
                                    <div class="col-sm-3">
                            ...
                            <!--表格开始    -->
                            <form action="/WebHome/index.php/Admin/MiddleLevel/lists/p/5.html" method="post" name="updateSort" id="updateSort" >
